...
namespace engine {
	...
	public:
		...
		void draw_image(ImageID image_id, IVec2 pos, Rect clip = {}, float alpha = 1.0f, RGBA tint = RGBA::white());
		void draw_image_scaled(ImageID image_id, Rect rect, Rect clip = {}, float alpha = 1.0f, RGBA tint = RGBA::white());
